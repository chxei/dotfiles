...
#rpmfusion goodies
sudo dnf group install multimedia sound-and-video  "C Development Tools and Libraries" "Development Tools" "Development Libraries" --with-optional --allowerasing --best --skip-broken -y;

#some usefull apps
sudo dnf install \
falkon plasma-browser-integration fwupd htop git neofetch \
...
llvm-static.x86_64 llvm-libs llvm-libs lld llvm clang-devel clang gcc glibc-devel zlib-devel libstdc++-static -y;
